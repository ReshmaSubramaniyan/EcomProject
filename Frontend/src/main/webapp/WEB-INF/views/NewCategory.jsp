...
<body>
	<script>
		function formCategory() {
			...
			var categorydescription = document
					.getElementById('categorydescription');
			// Check each input in the order that it appears in the form!

			if (notEmpty(categoryname, "Category Name Should not be empty")) {
				if (isAlphabet(categoryname,
						"Please enter only letters forCategory Name")) {
					if (notEmpty(categorydescription,
	...
	<form class="form-horizontal" action="addCategory" method="post"
		...
		<div class="form-group">
			<label class="control-label col-sm-offset-2 col-sm-3" for="email">Category
				:</label>
			<div class="col-sm-3">
				<input type="text" class="form-control" name="categoryName"
					id="categoryname" placeholder="Enter Category type">
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-sm-offset-2 col-sm-3" for="pwd">Description
				:</label>
			<div class="col-sm-3">
				<input type="text" class="form-control" name="categoryDescription"
					id="categorydescription" placeholder="Enter description">
			</div>
		</div>
		<div class="form-group">
