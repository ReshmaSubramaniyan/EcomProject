...
<div style="margin-top: 100px;" class="container">
	<c:if test="${!flag}">
		<form action="addAddress" method="post" class="form-horizontal" onsubmit="return formShiping()">
	</c:if>
	
	<c:if test="${flag}">
		<form action="updateAdd" method="post" class="form-horizontal" onsubmit="return formShiping()">
	</c:if>
					...
					<div class="form-group">
						...
						<div class="col-xs-9">
							<input type="text" class="form-control"
								value="${ship.shipmentId}" name="shippingId" readonly="readonly">
						</div>
					</div>
				</c:if>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-xs-9">
						<input type="text" class="form-control" id="contactNumber"
							value="${ship.contactNumber }" name="contactNumber"
