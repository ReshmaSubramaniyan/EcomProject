...
<form class="form-horizontal" action="supplierEdited" method="post" onsubmit="return formSupplier()" enctype="multipart/form-data">
  <div class="form-group">
    ...
    <div class="form-group">
    <label class="control-label col-sm-offset-2 col-sm-3" for="pwd">SupplierName :</label>
    <div class="col-sm-3"> 
      <input type="text" class= "form-control" name="supplierName" value="${supplier.supplierName}">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-offset-2 col-sm-3" for="password">SupplierDescription :</label>
    <div class="col-sm-3"> 
